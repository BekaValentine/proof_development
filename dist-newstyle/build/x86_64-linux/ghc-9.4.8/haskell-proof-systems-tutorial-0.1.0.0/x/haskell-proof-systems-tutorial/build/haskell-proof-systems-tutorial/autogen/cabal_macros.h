...
/* package haskell-proof-systems-tutorial-0.1.0.0 */
#ifndef VERSION_haskell_proof_systems_tutorial
#define VERSION_haskell_proof_systems_tutorial "0.1.0.0"
#endif /* VERSION_haskell_proof_systems_tutorial */
#ifndef MIN_VERSION_haskell_proof_systems_tutorial
#define MIN_VERSION_haskell_proof_systems_tutorial(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_proof_systems_tutorial */
...
#define CURRENT_COMPONENT_ID "haskell-proof-systems-tutorial-0.1.0.0-inplace-haskell-proof-systems-tutorial"
